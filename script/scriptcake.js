$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','Let’s make a cake!','Since it’s your birthday, I find it only fitting that you get to make your own birthday cake. Start by making  cake mixture, bake it in an oven and decorate.');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 3){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','Mix successful!','The mixture is perfect! It’s now time to put it in our digital oven for about 3 seconds. That should be enough time for a nice spongy base.');
...
$( ".oven" ).droppable({
    drop: function( event, ui ) {
        $('.stage3').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','Bake successfull!','The base looks yummy. Now its time to combine the base with lots of jam, chocolate and more.');
    }
})
